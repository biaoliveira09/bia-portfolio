	...
	if (isSuccess) {
		...
		return (
			<>
				...
				>
					<div className="project-container z-20 mx-20 flex flex-col items-center gap-7 rounded-2xl bg-stone-50/30 p-6 md:p-10 lg:w-8/12">
						<Reveal>
							...
							<div className="flex items-center justify-center">
								{project_screenshot ? (
									<img
										...
										className="w-80 rounded bg-violet-100 shadow-lg sm:w-96 md:w-9/12 lg:w-11/12"
									/>
								) : (
									<img
										src={placeholder}
						...
						<Reveal>
							<section className="other-projects z-30 flex flex-col items-center">
								...
								<Carousel currentProject={project_slug} />
							</section>
						</Reveal>
					</div>
				</main>
